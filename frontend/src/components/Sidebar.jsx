...
export default function Sidebar({ user }) {
	return (
		<div className='bg-slate-300 bg-secondary rounded-lg shadow bg-sky'>
			<div className='p-4 text-center'>
				<div
					className='h-16 rounded-t-lg bg-cover bg-center bg-primary'
					style={{
				...
				<p className='text-info'>player</p>
				<p className='text-info text-xs'>{user.connections.length} collabstars</p>
			</div>
